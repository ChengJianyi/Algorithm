...
Gaussian::Gaussian(int d):dimension(d),threhold(0.0001),pi(3.1416),gCovMatrix(MatrixXd::Zero(dimension, dimension)),gExpVector(VectorXd::Zero(dimension)),alpha(0){}
...
void Gaussian::setExpItem(double& e, int& i)
{
    gExpVector(i) = e;   
}
/*
double Gaussian::calcDistance(const VectorXd& v, c)
{
    double sum = 0;
...
void Gaussian::cluster(Sample& s)
{
